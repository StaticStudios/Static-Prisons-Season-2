    ...
    public static void main() {
        GUIPage guiPage = new GUIPage() {
            ...
            public void onOpen(Player player) {
                ...
                int amount = 1;
                menuItems.add(GUI.createEnchantedMenuItem(identifier, Material.COAL, ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Prestige 1 Time","", ChatColor.AQUA + "" + ChatColor.BOLD + "Costs:", ChatColor.AQUA + "" + ChatColor.BOLD + "│" + ChatColor.AQUA + " $" + Utils.prettyNum(RankUpPrices.getPrestigePrice(playerData.getPrestige(), amount)), ChatColor.AQUA + "" + ChatColor.BOLD + "│" + ChatColor.AQUA + " $" + Utils.addCommasToBigInteger(RankUpPrices.getPrestigePrice(playerData.getPrestige(), amount))));
                amount = 5;
                menuItems.add(GUI.createEnchantedMenuItem(identifier, Material.RAW_IRON, ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Prestige " + Utils.addCommasToInt(amount) + " Times", "", ChatColor.AQUA + "" + ChatColor.BOLD + "Costs:", ChatColor.AQUA + "" + ChatColor.BOLD + "│" + ChatColor.AQUA + " $" + Utils.prettyNum(RankUpPrices.getPrestigePrice(playerData.getPrestige(), amount)), ChatColor.AQUA + "" + ChatColor.BOLD + "│" + ChatColor.AQUA + " $" + Utils.addCommasToBigInteger(RankUpPrices.getPrestigePrice(playerData.getPrestige(), amount))));
                amount = 10;
                menuItems.add(GUI.createEnchantedMenuItem(identifier, Material.RAW_GOLD, ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Prestige " + Utils.addCommasToInt(amount) + " Times", "", ChatColor.AQUA + "" + ChatColor.BOLD + "Costs:", ChatColor.AQUA + "" + ChatColor.BOLD + "│" + ChatColor.AQUA + " $" + Utils.prettyNum(RankUpPrices.getPrestigePrice(playerData.getPrestige(), amount)), ChatColor.AQUA + "" + ChatColor.BOLD + "│" + ChatColor.AQUA + " $" + Utils.addCommasToBigInteger(RankUpPrices.getPrestigePrice(playerData.getPrestige(), amount))));
                amount = 50;
                menuItems.add(GUI.createEnchantedMenuItem(identifier, Material.DIAMOND, ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Prestige " + Utils.addCommasToInt(amount) + " Times", "", ChatColor.AQUA + "" + ChatColor.BOLD + "Costs:", ChatColor.AQUA + "" + ChatColor.BOLD + "│" + ChatColor.AQUA + " $" + Utils.prettyNum(RankUpPrices.getPrestigePrice(playerData.getPrestige(), amount)), ChatColor.AQUA + "" + ChatColor.BOLD + "│" + ChatColor.AQUA + " $" + Utils.addCommasToBigInteger(RankUpPrices.getPrestigePrice(playerData.getPrestige(), amount))));
                amount = 100;
                menuItems.add(GUI.createEnchantedMenuItem(identifier, Material.EMERALD, ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Prestige " + Utils.addCommasToInt(amount) + " Times", "", ChatColor.AQUA + "" + ChatColor.BOLD + "Costs:", ChatColor.AQUA + "" + ChatColor.BOLD + "│" + ChatColor.AQUA + " $" + Utils.prettyNum(RankUpPrices.getPrestigePrice(playerData.getPrestige(), amount)), ChatColor.AQUA + "" + ChatColor.BOLD + "│" + ChatColor.AQUA + " $" + Utils.addCommasToBigInteger(RankUpPrices.getPrestigePrice(playerData.getPrestige(), amount))));
                amount = 500;
                menuItems.add(GUI.createEnchantedMenuItem(identifier, Material.NETHERITE_INGOT, ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Prestige " + Utils.addCommasToInt(amount) + " Times", "", ChatColor.AQUA + "" + ChatColor.BOLD + "Costs:", ChatColor.AQUA + "" + ChatColor.BOLD + "│" + ChatColor.AQUA + " $" + Utils.prettyNum(RankUpPrices.getPrestigePrice(playerData.getPrestige(), amount)), ChatColor.AQUA + "" + ChatColor.BOLD + "│" + ChatColor.AQUA + " $" + Utils.addCommasToBigInteger(RankUpPrices.getPrestigePrice(playerData.getPrestige(), amount))));
                amount = 1000;
                menuItems.add(GUI.createEnchantedMenuItem(identifier, Material.AMETHYST_CLUSTER, ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Prestige " + Utils.addCommasToInt(amount) + " Times", "", ChatColor.AQUA + "" + ChatColor.BOLD + "Costs:", ChatColor.AQUA + "" + ChatColor.BOLD + "│" + ChatColor.AQUA + " $" + Utils.prettyNum(RankUpPrices.getPrestigePrice(playerData.getPrestige(), amount)), ChatColor.AQUA + "" + ChatColor.BOLD + "│" + ChatColor.AQUA + " $" + Utils.addCommasToBigInteger(RankUpPrices.getPrestigePrice(playerData.getPrestige(), amount))));
                amount = 5000;
