    ...
    public static void RankUp() {
        GUIPage guiPage = new GUIPage() {
            ...
            public void itemClicked(InventoryClickEvent e) {
                ...
                player.sendMessage(ChatColor.RED + "You do not have enough money to rank up! To rank up, it will cost: $" + Utils.addCommasToBigInteger(RankUp.calculatePriceToRankUpTo(playerData, e.getSlot())));
            }
        };
