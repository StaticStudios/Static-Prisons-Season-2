    ...
    public static void changeBlock() {
        GUIPage guiPage = new GUIPage() {
            ...
            public void onOpen(Player player) {
                ...
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (!(playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[2])) < 0 || playerData.getPlayerRanks().contains("master"))) return;
                type = Material.NETHER_BRICKS;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (!(playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[2])) < 0 || playerData.getPlayerRanks().contains("master"))) return;
                type = Material.QUARTZ_BLOCK;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (!(playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[2])) < 0 || playerData.getPlayerRanks().contains("mythic"))) return;
                type = Material.END_STONE;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (!(playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[2])) < 0 || playerData.getPlayerRanks().contains("mythic"))) return;
                type = Material.OBSIDIAN;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (!(playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[2])) < 0 || playerData.getPlayerRanks().contains("static"))) return;
                type = Material.CRYING_OBSIDIAN;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (!(playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[2])) < 0 || playerData.getPlayerRanks().contains("staticp"))) return;
