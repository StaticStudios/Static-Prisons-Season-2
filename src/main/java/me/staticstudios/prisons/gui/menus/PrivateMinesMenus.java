    ...
    public static void changeBlock() {
        GUIPage guiPage = new GUIPage() {
            ...
            public void onOpen(Player player) {
                ...
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (!(playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[2])) < 0 || playerData.getPlayerRanks().contains("warrior"))) return;
                type = Material.NETHERRACK;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (!(playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[3])) < 0 || playerData.getPlayerRanks().contains("master"))) return;
                type = Material.NETHER_BRICKS;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (!(playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[4])) < 0 || playerData.getPlayerRanks().contains("master"))) return;
                type = Material.QUARTZ_BLOCK;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (!(playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[5])) < 0 || playerData.getPlayerRanks().contains("mythic"))) return;
                type = Material.END_STONE;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (!(playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[6])) < 0 || playerData.getPlayerRanks().contains("mythic"))) return;
                type = Material.OBSIDIAN;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (!(playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[7])) < 0 || playerData.getPlayerRanks().contains("static"))) return;
                type = Material.CRYING_OBSIDIAN;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (!(playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[8])) < 0 || playerData.getPlayerRanks().contains("staticp"))) return;
                type = Material.PRISMARINE;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (!(playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[9])) < 0 || playerData.getPlayerRanks().contains("staticp"))) return;
                type = Material.AMETHYST_BLOCK;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[10])) < 0) return;
                type = Material.DEEPSLATE_COAL_ORE;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[11])) < 0) return;
                type = Material.DEEPSLATE_IRON_ORE;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[12])) < 0) return;
                type = Material.DEEPSLATE_GOLD_ORE;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[13])) < 0) return;
                type = Material.DEEPSLATE_DIAMOND_ORE;
                menuItems.add(GUI.createMenuItem(identifier, type, Utils.getPrettyItemName(new ItemStack(type)), lore));
                if (playerData.getPrestige().compareTo(BigInteger.valueOf(StaticVars.PRESTIGE_MINE_REQUIREMENTS[14])) < 0) return;
