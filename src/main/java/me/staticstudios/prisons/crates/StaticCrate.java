...
public class StaticCrate {
    ...
    public static CrateReward[] rewards = new CrateReward[] {
            ...
            new CrateReward(Utils.setItemCount(Vouchers.MONEY_POUCH_T1.item, 2), 10.5),
            new CrateReward(Utils.setItemCount(Vouchers.MONEY_POUCH_T1.item, 3), 7),
            new CrateReward(Vouchers.MONEY_POUCH_T2.item, 7.5),
            new CrateReward(Utils.setItemCount(Vouchers.MONEY_POUCH_T2.item, 2), 5),
            new CrateReward(Utils.setItemCount(Vouchers.MONEY_POUCH_T2.item, 3), 6),
            new CrateReward(Vouchers.TOKEN_POUCH_T1.item, 5),
            new CrateReward(Utils.setItemCount(Vouchers.TOKEN_POUCH_T1.item, 2), 9.5),
            new CrateReward(Utils.setItemCount(Vouchers.TOKEN_POUCH_T1.item, 3), 8),
            new CrateReward(Vouchers.TOKEN_POUCH_T2.item, 7.5),
            new CrateReward(Utils.setItemCount(Vouchers.TOKEN_POUCH_T2.item, 2), 5),
            new CrateReward(Utils.setItemCount(Vouchers.TOKEN_POUCH_T2.item, 3), 4),
            ...
            new CrateReward(CustomItems.getStaticpCrateKey(1), 2),
            new CrateReward(CustomItems.getStaticpCrateKey(2), 0.5),
            new CrateReward(CustomItems.getStaticpCrateKey(3), 0.5),
            new CrateReward(CustomItems.getPickaxeCrateKey(1), 4),
            new CrateReward(CustomItems.getPickaxeCrateKey(2), 2.945),
            new CrateReward(CustomItems.getKitCrateKey(1), 2),
            new CrateReward(Vouchers.AUTO_SELL.item, 0.01),
            new CrateReward(Vouchers.WARRIOR_RANK.item, 0.005),
            new CrateReward(Vouchers.MASTER_RANK.item, 0.005),
            new CrateReward(Vouchers.MYTHIC_RANK.item, 0.005),
            new CrateReward(Vouchers.PRIVATE_MINE_T1.item, 0.01),
            new CrateReward(Vouchers.PRIVATE_MINE_T2.item, 0.01),
            new CrateReward(Vouchers.PRIVATE_MINE_T3.item, 0.005),
            new CrateReward(Vouchers.PRIVATE_MINE_T4.item, 0.005),
            new CrateReward(Vouchers.PRIVATE_MINE_T5.item, 0.005),
    };
