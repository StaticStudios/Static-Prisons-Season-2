        ...
        GUIPage guiPage = new GUIPage() {
            ...
            public void onOpen(Player player) {
               ...
               currentPMine = 2;
                ...
                menuItems.add(GUI.createLightGrayPlaceholderItem());
                menuItems.add(GUI.createEnchantedMenuItem(identifier, Material.ENCHANTING_TABLE, ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Event Mine", ChatColor.AQUA + "Click to warp!", "", ChatColor.GRAY + "" + ChatColor.ITALIC + "110% Token multiplier"));
                menuItems.add(GUI.createLightGrayPlaceholderItem());
