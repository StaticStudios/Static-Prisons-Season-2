...
public class GUI {
    ...
    public static ItemStack createMenuItemOfPlayerSkull(String fromPage, OfflinePlayer playerToGetSkullOf, String name, String... lore) {
        ...
        itemMeta.getPersistentDataContainer().set(new NamespacedKey(Main.getMain(), "guiItem"), PersistentDataType.STRING, "normal");
        itemMeta.getPersistentDataContainer().set(new NamespacedKey(Main.getMain(), "fromPage"), PersistentDataType.STRING, fromPage);
    ...
    public static ItemStack createBackButton(String fromPage, String menuToGoTo) {
        ...
        ItemMeta itemMeta = item.getItemMeta();
        itemMeta.getPersistentDataContainer().set(new NamespacedKey(Main.getMain(), "guiItem"), PersistentDataType.STRING, "backButton");
        itemMeta.getPersistentDataContainer().set(new NamespacedKey(Main.getMain(), "fromPage"), PersistentDataType.STRING, fromPage);
        itemMeta.getPersistentDataContainer().set(new NamespacedKey(Main.getMain(), "menuToGoTo"), PersistentDataType.STRING, menuToGoTo);
