...
public class CustomItemsCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        ItemStack item;
        if (args.length == 0) {
            player.sendMessage(CommandUtils.getIncorrectCommandUsageMessage("/customitems <common_key|rare_key|epic_key|legendary_key|static_key|staticp_key|vote_key|kit_key|pickaxe_key|money_pouch_1|money_pouch_2|money_pouch_3|token_pouch_1|token_pouch_2|token_pouch_3|pickaxe_1|pickaxe_2|pickaxe_3|pickaxe_4|pickaxe_5|pickaxe_6|pickaxe_7|pickaxe_8|pickaxe_9|pickaxe_10|pmine_voucher_1|pmine_voucher_2|pmine_voucher_3|pmine_voucher_4|pmine_voucher_5|pmine_voucher_6|pmine_voucher_7|pmine_voucher_8|pmine_voucher_9|pmine_voucher_10|pmine_voucher_11|warrior_voucher|master_voucher|mythic_voucher|static_voucher|staticp_voucher|kit_1|kit_2|kit_3|kit_4|kit_5|kit_6|kit_weapons|kit_potions>"));
            return false;
        }
        switch (args[0].toLowerCase()) {
            ...
            case "kit_potions" -> item = Vouchers.KIT_POTIONS.item;
            default -> {
                player.sendMessage(CommandUtils.getIncorrectCommandUsageMessage("/customitems <common_key|rare_key|epic_key|legendary_key|static_key|staticp_key|vote_key|kit_key|pickaxe_key|money_pouch_1|money_pouch_2|money_pouch_3|token_pouch_1|token_pouch_2|token_pouch_3|pickaxe_1|pickaxe_2|pickaxe_3|pickaxe_4|pickaxe_5|pickaxe_6|pickaxe_7|pickaxe_8|pickaxe_9|pickaxe_10|pmine_voucher_1|pmine_voucher_2|pmine_voucher_3|pmine_voucher_4|pmine_voucher_5|pmine_voucher_6|pmine_voucher_7|pmine_voucher_8|pmine_voucher_9|pmine_voucher_10|pmine_voucher_11|warrior_voucher|master_voucher|mythic_voucher|static_voucher|staticp_voucher|kit_1|kit_2|kit_3|kit_4|kit_5|kit_6|kit_weapons|kit_potions>"));
                return false;
            }
