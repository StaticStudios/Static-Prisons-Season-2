...
public class PrisonEnchants {
    ...
    public static final PrisonEnchant JACK_HAMMER = new PrisonEnchant("jackHammer", 20000, BigInteger.valueOf(300)); //Destroy a layer of the mine
    public static final PrisonEnchant DOUBLE_WAMMY = new PrisonEnchant("doubleWammy", 1000, BigInteger.valueOf(10000)); //Chance to destroy an additional mine layer
