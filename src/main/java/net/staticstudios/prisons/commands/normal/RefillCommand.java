...
import net.staticstudios.prisons.mines.old.MineManager;
...
public class RefillCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        if (args.length == 0) {
            player.sendMessage(PrisonUtils.Commands.getCorrectUsage("/refill <mine>"));
            return false;
        }
        switch (args[0].toLowerCase()) {
            ...
            default -> player.sendMessage(PrisonUtils.Commands.getCorrectUsage("/refill <mine>"));
        }
        return false;
    }
}
