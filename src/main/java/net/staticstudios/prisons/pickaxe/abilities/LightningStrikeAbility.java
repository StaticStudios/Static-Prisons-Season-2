...
//            blockBreak.stats().getMinedBlocks().put(mb, blockBreak.stats().getMinedBlocks().getOrDefault(mb, 0L) + entry.getValue());
//        }
//        blockBreak.stats().setBlocksBroken(blockBreak.stats().getBlocksBroken() + lightningStrikeBomb.blocksChanged);
