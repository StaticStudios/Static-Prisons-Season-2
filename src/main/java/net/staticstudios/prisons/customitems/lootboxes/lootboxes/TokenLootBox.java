    ...
    public List<Component> getLore() {
        return List.of(
                ...
                LORE_PREFIX.append(Component.text("Reward: ").color(ComponentUtil.GOLD))
                        .append(Component.text(PrisonUtils.addCommasToNumber(getType().getMinCurrencyReward(tier)) + " - " + PrisonUtils.addCommasToNumber(getType().getMaxCurrencyReward(tier)) + " Tokens").color(ComponentUtil.WHITE)).decoration(TextDecoration.ITALIC, false)
        );
    }
