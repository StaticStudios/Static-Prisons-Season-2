    ...
    public static void minesMenuAZ(Player player) {
        ...
        c.setItems(
                createMineWarp(c, playerData.getMineRank() >= 0, "&c&lMine A", "&a&lMine A",
                        new String[]{"&cYou do not have this unlocked!", "", "&7&oSize: 71x99x71"}, new String[]{"&aClick to warp!", "", "&7&oSize: 71x99x71"},
    ...
    public static void minesMenuRanked(Player player) {
        ...
        c.setItems(
                ...
                createMineWarp(c, playerData.getPlayerRanks().contains("warrior"), "&c&lWarrior Mine", "&4&lWarrior Mine",
                        new String[]{"&b&oRequires &nwarrior&b&o rank (or higher)", "&b&oPurchasable at &nstore.static-studios.net", "", "&cYou do not have this unlocked!", "", "&7&oSize: 79x99x79"},
                        new String[]{"&b&oRequires &nwarrior&b&o rank (or higher)", "&b&oPurchasable at &nstore.static-studios.net", "", "&aClick to warp!", "", "&7&oSize: 79x99x79"},
                ...
                createMineWarp(c, playerData.getPlayerRanks().contains("master"), "&c&lMaster Mine", "&4&lMaster Mine",
                        new String[]{"&b&oRequires &nmaster&b&o rank (or higher)", "&b&oPurchasable at &nstore.static-studios.net", "", "&cYou do not have this unlocked!", "", "&7&oSize: 89x99x89"},
                        new String[]{"&b&oRequires &nmaster&b&o rank (or higher)", "&b&oPurchasable at &nstore.static-studios.net", "", "&aClick to warp!", "", "&7&oSize: 89x99x89"},
                ...
                createMineWarp(c, playerData.getPlayerRanks().contains("mythic"), "&c&lMythic Mine", "&4&lMythic Mine",
                        new String[]{"&b&oRequires &nmythic&b&o rank (or higher)", "&b&oPurchasable at &nstore.static-studios.net", "", "&cYou do not have this unlocked!", "", "&7&oSize: 99x99x99"},
                        new String[]{"&b&oRequires &nmythic&b&o rank (or higher)", "&b&oPurchasable at &nstore.static-studios.net", "", "&aClick to warp!", "", "&7&oSize: 99x99x99"},
                ...
                createMineWarp(c, playerData.getPlayerRanks().contains("static"), "&c&lStatic Mine", "&4&lStatic Mine",
                        new String[]{"&b&oRequires &nstatic&b&o rank (or higher)", "&b&oPurchasable at &nstore.static-studios.net", "", "&cYou do not have this unlocked!", "", "&7&oSize: 129x99x129"},
                        new String[]{"&b&oRequires &nstatic&b&o rank (or higher)", "&b&oPurchasable at &nstore.static-studios.net", "", "&aClick to warp!", "", "&7&oSize: 129x99x129"},
                ...
                createMineWarp(c, playerData.getPlayerRanks().contains("staticp"), "&c&lStatic+ Mine", "&4&lStatic+ Mine",
                        new String[]{"&b&oRequires &nstatic+&b&o rank (or higher)", "&b&oPurchasable at &nstore.static-studios.net", "", "&cYou do not have this unlocked!", "", "&7&oSize: 151x99x151"},
                        new String[]{"&b&oRequires &nstatic+&b&o rank (or higher)", "&b&oPurchasable at &nstore.static-studios.net", "", "&aClick to warp!", "", "&7&oSize: 151x99x151"},
