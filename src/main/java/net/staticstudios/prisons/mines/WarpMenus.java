    ...
    public static void minesMenuAZ(Player player) {
        ...
        c.setItems(
                createMineWarp(c, playerData.getMineRank() >= 0, "&c&lMine A", "&a&lMine A",
                        new String[]{"&cYou do not have this unlocked!", "", "&7&oSize: 71x98x71"}, new String[]{"&aClick to warp!", "", "&7&oSize: 71x98x71"},
                ...
                createMineWarp(c, playerData.getMineRank() >= 13, "&c&lMine N", "&a&lMine N",
                        new String[]{"&cYou do not have this unlocked!", "", "&7&oSize: 71x98x71"}, new String[]{"&aClick to warp!", "", "&7&oSize: 69x98x69"},
                        Material.GOLD_ORE, Material.GOLD_ORE, (p, t) -> {
                            p.sendMessage(ChatColor.RED + "You do not have this mine unlocked!");
                        }, (p, t) -> {
    ...
    public static void minesMenuPrestige(Player player) {
        ...
        c.setItems(
                createMineWarp(c, playerData.getPrestige().compareTo(BigInteger.valueOf(Constants.PRESTIGE_MINE_REQUIREMENTS[0])) > -1, "&c&lPrestige Mine #1", "&d&lPrestige Mine #1",
                        new String[]{"&bRequires " + PrisonUtils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[0]) + " prestiges", "", "&cYou do not have this unlocked!", "", "&7&oSize: 75x98x75"},
                        new String[]{"&bRequires " + PrisonUtils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[0]) + " prestiges", "", "&aClick to warp!", "", "&7&oSize: 75x98x75"},
                ...
                createMineWarp(c, playerData.getPrestige().compareTo(BigInteger.valueOf(Constants.PRESTIGE_MINE_REQUIREMENTS[1])) > -1, "&c&lPrestige Mine #2", "&d&lPrestige Mine #2",
                        new String[]{"&bRequires " + PrisonUtils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[1]) + " prestiges", "", "&cYou do not have this unlocked!", "", "&7&oSize: 75x98x75"},
                        new String[]{"&bRequires " + PrisonUtils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[1]) + " prestiges", "", "&aClick to warp!", "", "&7&oSize: 75x98x75"},
                ...
                createMineWarp(c, playerData.getPrestige().compareTo(BigInteger.valueOf(Constants.PRESTIGE_MINE_REQUIREMENTS[2])) > -1, "&c&lPrestige Mine #3", "&d&lPrestige Mine #3",
                        new String[]{"&bRequires " + PrisonUtils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[2]) + " prestiges", "", "&cYou do not have this unlocked!", "", "&7&oSize: 75x98x75"},
                        new String[]{"&bRequires " + PrisonUtils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[2]) + " prestiges", "", "&aClick to warp!", "", "&7&oSize: 75x98x75"},
                ...
                createMineWarp(c, playerData.getPrestige().compareTo(BigInteger.valueOf(Constants.PRESTIGE_MINE_REQUIREMENTS[3])) > -1, "&c&lPrestige Mine #4", "&d&lPrestige Mine #4",
                        new String[]{"&bRequires " + PrisonUtils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[3]) + " prestiges", "", "&cYou do not have this unlocked!", "", "&7&oSize: 75x98x75"},
                        new String[]{"&bRequires " + PrisonUtils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[3]) + " prestiges", "", "&aClick to warp!", "", "&7&oSize: 75x98x75"},
                ...
                createMineWarp(c, playerData.getPrestige().compareTo(BigInteger.valueOf(Constants.PRESTIGE_MINE_REQUIREMENTS[4])) > -1, "&c&lPrestige Mine #5", "&d&lPrestige Mine #5",
                        new String[]{"&bRequires " + PrisonUtils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[4]) + " prestiges", "", "&cYou do not have this unlocked!", "", "&7&oSize: 75x98x75"},
                        new String[]{"&bRequires " + PrisonUtils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[4]) + " prestiges", "", "&aClick to warp!", "", "&7&oSize: 75x98x75"},
