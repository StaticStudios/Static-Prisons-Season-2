...
import net.staticstudios.prisons.mines.old.MineBlock;
import net.staticstudios.prisons.mines.old.PrivateMine;
import net.staticstudios.prisons.mines.old.PublicMine;
...
public class MineManager {
    ...
    public static void initialize() {
        ...
        mine.setBlockPattern(new MineBlock[]{
                new MineBlock(Material.STONE, 6),
                ...
                new MineBlock(Material.NETHERRACK, 2),
                new MineBlock(Material.NETHER_BRICKS, 2),
                new MineBlock(Material.QUARTZ_BLOCK, 2),
                new MineBlock(Material.END_STONE, 2),
                new MineBlock(Material.OBSIDIAN, 2),
                new MineBlock(Material.CRYING_OBSIDIAN, 2),
                new MineBlock(Material.PRISMARINE, 2),
                new MineBlock(Material.DEEPSLATE_COAL_ORE, 2),
                new MineBlock(Material.DEEPSLATE_IRON_ORE, 2),
                new MineBlock(Material.DEEPSLATE_GOLD_ORE, 2),
                new MineBlock(Material.DEEPSLATE_DIAMOND_ORE, 2),
                new MineBlock(Material.DEEPSLATE_EMERALD_ORE, 2),
        });
