package net.staticstudios.prisons.chat.messaging;
...
public final class MessageHandler {
    ...
    public static void sendMessage(Player from, Player to, String message) {
        ...
        for (Player p : Bukkit.getOnlinePlayers())
            if (new PlayerData(p).getIsWatchingMessages())
                p.sendMessage(ChatColor.GRAY + "" + ChatColor.ITALIC + from.getName() + " said to " + to.getName() + ": " + message);
    }
}
