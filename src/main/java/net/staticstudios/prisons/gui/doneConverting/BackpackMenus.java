    ...
    public static void main() {
        ...
        GUIPage guiPage = new GUIPage() {
            ...
            public void onOpen(Player player) {
                ...
                menuItems.add(GUI.createMenuItem(identifier, Material.CHEST, ChatColor.GREEN + "" + ChatColor.BOLD + "Add " + PrisonUtils.addCommasToNumber(amount) + " Slot","",
                        ChatColor.AQUA + "Current Size: " + ChatColor.WHITE + PrisonUtils.addCommasToNumber(playerData.getBackpackSize()) + " Slots",
                        ChatColor.AQUA + "Costs: " + ChatColor.WHITE + PrisonUtils.addCommasToNumber(BigInteger.valueOf(slotCost).multiply(amount.divide(BigInteger.valueOf(slotsPerCost)))) + " Tokens",
                        ChatColor.AQUA + "Your Tokens: " + ChatColor.WHITE + PrisonUtils.prettyNum(playerData.getTokens()), "",
                        ChatColor.GRAY + "Max Size: a lot"));
                menuItems.get(0).setAmount(1);
                amount = BigInteger.valueOf(slotsPerCost * 10);
                menuItems.add(GUI.createMenuItem(identifier, Material.CHEST, ChatColor.GREEN + "" + ChatColor.BOLD + "Add " + PrisonUtils.addCommasToNumber(amount) + " Slots","",
                        ChatColor.AQUA + "Current Size: " + ChatColor.WHITE + PrisonUtils.addCommasToNumber(playerData.getBackpackSize()) + " Slots",
                        ChatColor.AQUA + "Costs: " + ChatColor.WHITE + PrisonUtils.addCommasToNumber(BigInteger.valueOf(slotCost).multiply(amount.divide(BigInteger.valueOf(slotsPerCost)))) + " Tokens",
                        ChatColor.AQUA + "Your Tokens: " + ChatColor.WHITE + PrisonUtils.prettyNum(playerData.getTokens()), "",
                        ChatColor.GRAY + "Max Size: a lot"));
                ...
                menuItems.add(GUI.createMenuItem(identifier, Material.CHEST, ChatColor.GREEN + "" + ChatColor.BOLD + "Add " + PrisonUtils.addCommasToNumber(amount) + " Slots", ChatColor.GRAY + "" + ChatColor.ITALIC + "Max you can buy with your current tokens", "",
                        ChatColor.AQUA + "Current Size: " + ChatColor.WHITE + PrisonUtils.addCommasToNumber(playerData.getBackpackSize()) + " Slots",
                        ChatColor.AQUA + "Costs: " + ChatColor.WHITE + PrisonUtils.addCommasToNumber(BigInteger.valueOf(slotCost).multiply(amount.divide(BigInteger.valueOf(slotsPerCost)))) + " Tokens",
                        ChatColor.AQUA + "Your Tokens: " + ChatColor.WHITE + PrisonUtils.prettyNum(playerData.getTokens()), "",
                        ChatColor.GRAY + "Max Size: a lot"));
