        ...
        GUIPage guiPage = new GUIPage() {
            ...
            public void onOpen(Player player) {
               ...
               currentPMine = 2;
                ...
                currentPMine = 5;
                if (playerData.getPrestige().compareTo(BigInteger.valueOf(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine])) > -1) {
                    menuItems.add(GUI.createEnchantedMenuItem(identifier, prestigeMineWarpMaterials[currentPMine], ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Prestige Mine #" + (currentPMine + 1), ChatColor.AQUA + "" + ChatColor.ITALIC + "Requires " + Utils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine]) + " prestiges", "", ChatColor.GREEN + "Click to warp!", "", ChatColor.GRAY + "" + ChatColor.ITALIC + "Size: 89x98x89"));
                ...
                currentPMine = 10;
                if (playerData.getPrestige().compareTo(BigInteger.valueOf(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine])) > -1) {
                    menuItems.set(31, GUI.createEnchantedMenuItem(identifier, prestigeMineWarpMaterials[currentPMine], ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Prestige Mine #" + (currentPMine + 1), ChatColor.AQUA + "" + ChatColor.ITALIC + "Requires " + Utils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine]) + " prestiges", "", ChatColor.GREEN + "Click to warp!", "", ChatColor.GRAY + "" + ChatColor.ITALIC + "Size: 109x98x109"));
                ...
                currentPMine = 14;
                if (playerData.getPrestige().compareTo(BigInteger.valueOf(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine])) > -1) {
                    menuItems.add(17, GUI.createEnchantedMenuItem(identifier, prestigeMineWarpMaterials[currentPMine], ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Prestige Mine #" + (currentPMine + 1), ChatColor.AQUA + "" + ChatColor.ITALIC + "Requires " + Utils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine]) + " prestiges", "", ChatColor.GREEN + "Click to warp!", "", ChatColor.GRAY + "" + ChatColor.ITALIC + "Size: 151x98x151"));
