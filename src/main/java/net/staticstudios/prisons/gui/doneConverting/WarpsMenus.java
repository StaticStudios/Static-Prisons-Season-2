            ...
            public void onOpen(Player player) {
                ...
                for (int i = 0; i < 26; i++) {
                    if (playerData.getMineRank() >= i) {
                        menuItems.add(GUI.createMenuItem(identifier, publicMineWarpMaterials[i / 3], ChatColor.GREEN + "" + ChatColor.BOLD + "Mine " + PrisonUtils.getMineRankLetterFromMineRank(i), ChatColor.GREEN + "Click to warp!", "", ChatColor.GRAY + "" + ChatColor.ITALIC + "Size: 69x98x69"));
                    } else menuItems.add(GUI.createMenuItem(identifier, Material.RED_STAINED_GLASS, ChatColor.RED + "" + ChatColor.BOLD + "Mine " + PrisonUtils.getMineRankLetterFromMineRank(i), ChatColor.RED + "You do not have this mine unlocked!", "", ChatColor.GRAY + "" + ChatColor.ITALIC + "Size: 69x98x69"));
                }
                int currentPMine;
                currentPMine = 0;
                if (playerData.getPrestige().compareTo(BigInteger.valueOf(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine])) > -1) {
                    menuItems.add(9, GUI.createEnchantedMenuItem(identifier, prestigeMineWarpMaterials[currentPMine], ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Prestige Mine #" + (currentPMine + 1), ChatColor.AQUA + "" + ChatColor.ITALIC + "Requires " + PrisonUtils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine]) + " prestiges", "", ChatColor.GREEN + "Click to warp!", "", ChatColor.GRAY + "" + ChatColor.ITALIC + "Size: 69x98x69"));
                } else menuItems.add(9, GUI.createEnchantedMenuItem(identifier, prestigeMineWarpMaterials[currentPMine], ChatColor.RED + "" + ChatColor.BOLD + "Prestige Mine #" + (currentPMine + 1), ChatColor.AQUA + "" + ChatColor.ITALIC + "Requires " + PrisonUtils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine]) + " prestiges", "", ChatColor.RED + "You do not have this mine unlocked!", "", ChatColor.GRAY + "" + ChatColor.ITALIC + "Size: 69x98x69"));
                currentPMine = 1;
                if (playerData.getPrestige().compareTo(BigInteger.valueOf(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine])) > -1) {
               ...
               currentPMine = 2;
                ...
                currentPMine = 5;
                if (playerData.getPrestige().compareTo(BigInteger.valueOf(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine])) > -1) {
                    menuItems.add(GUI.createEnchantedMenuItem(identifier, prestigeMineWarpMaterials[currentPMine], ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Prestige Mine #" + (currentPMine + 1), ChatColor.AQUA + "" + ChatColor.ITALIC + "Requires " + PrisonUtils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine]) + " prestiges", "", ChatColor.GREEN + "Click to warp!", "", ChatColor.GRAY + "" + ChatColor.ITALIC + "Size: 89x98x89"));
                ...
                currentPMine = 10;
                if (playerData.getPrestige().compareTo(BigInteger.valueOf(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine])) > -1) {
                    menuItems.set(31, GUI.createEnchantedMenuItem(identifier, prestigeMineWarpMaterials[currentPMine], ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Prestige Mine #" + (currentPMine + 1), ChatColor.AQUA + "" + ChatColor.ITALIC + "Requires " + PrisonUtils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine]) + " prestiges", "", ChatColor.GREEN + "Click to warp!", "", ChatColor.GRAY + "" + ChatColor.ITALIC + "Size: 109x98x109"));
                ...
                currentPMine = 14;
                if (playerData.getPrestige().compareTo(BigInteger.valueOf(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine])) > -1) {
                    menuItems.add(17, GUI.createEnchantedMenuItem(identifier, prestigeMineWarpMaterials[currentPMine], ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Prestige Mine #" + (currentPMine + 1), ChatColor.AQUA + "" + ChatColor.ITALIC + "Requires " + PrisonUtils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine]) + " prestiges", "", ChatColor.GREEN + "Click to warp!", "", ChatColor.GRAY + "" + ChatColor.ITALIC + "Size: 151x98x151"));
                } else menuItems.add(17, GUI.createEnchantedMenuItem(identifier, prestigeMineWarpMaterials[currentPMine], ChatColor.RED + "" + ChatColor.BOLD + "Prestige Mine #" + (currentPMine + 1), ChatColor.AQUA + "" + ChatColor.ITALIC + "Requires " + PrisonUtils.addCommasToNumber(Constants.PRESTIGE_MINE_REQUIREMENTS[currentPMine]) + " prestiges", "", ChatColor.RED + "You do not have this mine unlocked!", "", ChatColor.GRAY + "" + ChatColor.ITALIC + "Size: 151x98x151"));
                menuItems.add(GUI.createLightGrayPlaceholderItem());
                menuItems.add(GUI.createLightGrayPlaceholderItem());
                menuItems.add(GUI.createEnchantedMenuItem(identifier, Material.ENCHANTING_TABLE, ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Event Mine", ChatColor.AQUA + "Click to warp!", "", ChatColor.GRAY + "" + ChatColor.ITALIC + "120% Token multiplier"));
                menuItems.add(GUI.createLightGrayPlaceholderItem());
