    ...
    public static void init() {
        COMMON = new Crate("common", "Common Crate", "common", new Location(Bukkit.getWorld("world"), -51, 80, -137),
                new WeightedElements<CrateReward>()
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier1(), 2)), 20)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier1(), 3)), 10)
                        .add(new CrateReward(CustomItems.getMineBombTier2()), 5)
        ...
        RARE = new Crate("rare", "Rare Crate", "rare", new Location(Bukkit.getWorld("world"), -42, 80, -137),
                new WeightedElements<CrateReward>()
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier1(), 4)), 5)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier2(), 2)), 15)
                        .add(new CrateReward(CustomItems.getMineBombTier3()), 10)
        ...
        EPIC = new Crate("epic", "Epic Crate", "epic", new Location(Bukkit.getWorld("world"), -33, 80, -137),
                new WeightedElements<CrateReward>()
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier1(), 7)), 10)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier2(), 3)), 5)
                        .add(new CrateReward(CustomItems.getMineBombTier3()), 8)
                        .add(new CrateReward(CustomItems.getMineBombTier4()), 2)
                        ...
                        .add(new CrateReward(CustomItems.getKitCrateKey(1)), 2.5)
                        .add(new CrateReward(Vouchers.AUTO_SELL.item), 0.005)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T1.item), 0.005)
        );
        ...
        LEGENDARY = new Crate("legendary", "Legendary Crate", "legendary", new Location(Bukkit.getWorld("world"), -24, 80, -137),
                new WeightedElements<CrateReward>()
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier2(), 5)), 7.5)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier3(), 2)), 7.5)
                        .add(new CrateReward(CustomItems.getMineBombTier4()), 5)
                        ...
                        .add(new CrateReward(CustomItems.getKitCrateKey(1)), 2)
                        .add(new CrateReward(Vouchers.AUTO_SELL.item), 0.005)
                        .add(new CrateReward(Vouchers.WARRIOR_RANK.item), 0.005)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T1.item), 0.01)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T2.item), 0.005)
        );
        ...
        STATIC = new Crate("static", "Static Crate", "static", new Location(Bukkit.getWorld("world"), -15, 80, -137),
                new WeightedElements<CrateReward>()
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier2(), 8)), 5)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier3(), 3)), 7)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier3(), 4)), 5)
                        .add(new CrateReward(CustomItems.getMineBombTier4()), 2)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier4(), 2)), 1)
                        ...
                        .add(new CrateReward(CustomItems.getPickaxeCrateKey(1)), 4)
                        .add(new CrateReward(CustomItems.getPickaxeCrateKey(2)), 2.940)
                        .add(new CrateReward(CustomItems.getKitCrateKey(1)), 2)
                        ...
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T1.item), 0.01)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T2.item), 0.01)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T3.item), 0.005)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T4.item), 0.005)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T5.item), 0.005)
        );
        ...
        STATICP = new Crate("staticp", "Static+ Crate", "staticp", new Location(Bukkit.getWorld("world"), 3, 80, -137),
                new WeightedElements<CrateReward>()
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier1(), 32)), 2)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier3(), 4)), 5)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier3(), 6)), 5)
                        .add(new CrateReward(CustomItems.getMineBombTier4()), 2)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier4(), 2)), 2)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier4(), 4)), 1)
                        ...
                        .add(new CrateReward(CustomItems.getStaticpCrateKey(2)), 1.5)
                        .add(new CrateReward(CustomItems.getPickaxeCrateKey(3)), 3)
                        ...
                        .add(new CrateReward(Vouchers.STATICP_RANK.item), 0.4)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T1.item), 0.1)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T2.item), 0.1)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T3.item), 0.1)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T4.item), 0.1)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T5.item), 0.1)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T6.item), 0.1)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T7.item), 0.1)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T8.item), 0.1)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T9.item), 0.1)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T10.item), 0.1)
                        .add(new CrateReward(Vouchers.PRIVATE_MINE_T11.item), 0.1)
        );
        ...
        PICKAXE = new Crate("pickaxe", "Pickaxe Crate", "pickaxe", new Location(Bukkit.getWorld("world"), 12, 80, -137),
                new WeightedElements<CrateReward>()
                        .add(new CrateReward(PickaxeTemplates.TIER_1.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, new ItemStack(PickaxeTemplates.TIER_1.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item)), "1x " + PickaxeTemplates.TIER_1.DISPLAY_NAME), 25)
                        .add(new CrateReward(PickaxeTemplates.TIER_2.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, new ItemStack(PickaxeTemplates.TIER_2.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item)), "1x " + PickaxeTemplates.TIER_2.DISPLAY_NAME), 20)
                        .add(new CrateReward(PickaxeTemplates.TIER_3.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, new ItemStack(PickaxeTemplates.TIER_3.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item)), "1x " + PickaxeTemplates.TIER_3.DISPLAY_NAME), 15)
                        .add(new CrateReward(PickaxeTemplates.TIER_4.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, new ItemStack(PickaxeTemplates.TIER_4.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item)), "1x " + PickaxeTemplates.TIER_4.DISPLAY_NAME), 12.5)
                        .add(new CrateReward(PickaxeTemplates.TIER_5.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, new ItemStack(PickaxeTemplates.TIER_5.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item)), "1x " + PickaxeTemplates.TIER_5.DISPLAY_NAME), 10)
                        .add(new CrateReward(PickaxeTemplates.TIER_6.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, new ItemStack(PickaxeTemplates.TIER_6.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item)), "1x " + PickaxeTemplates.TIER_6.DISPLAY_NAME), 7.5)
                        .add(new CrateReward(PickaxeTemplates.TIER_7.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, new ItemStack(PickaxeTemplates.TIER_7.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item)), "1x " + PickaxeTemplates.TIER_7.DISPLAY_NAME), 6)
                        .add(new CrateReward(PickaxeTemplates.TIER_8.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, new ItemStack(PickaxeTemplates.TIER_8.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item)), "1x " + PickaxeTemplates.TIER_8.DISPLAY_NAME), 2.5)
                        .add(new CrateReward(PickaxeTemplates.TIER_9.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, new ItemStack(PickaxeTemplates.TIER_9.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item)), "1x " + PickaxeTemplates.TIER_9.DISPLAY_NAME), 1)
                        .add(new CrateReward(PickaxeTemplates.TIER_10.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, new ItemStack(PickaxeTemplates.TIER_10.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item)), "1x " + PickaxeTemplates.TIER_10.DISPLAY_NAME), 0.5)
        );
