...
public class Crates {
    ...
    public static void init() {
        ...
        PICKAXE = new Crate("pickaxe", "Pickaxe Crate", "pickaxe", new Location(Bukkit.getWorld("world"), 12, 80, -137),
                new WeightedElements<CrateReward>()
                        .add(new CrateReward(PickaxeTemplates.TIER_1.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, PickaxeTemplates.TIER_1.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item), "1x " + PickaxeTemplates.TIER_1.DISPLAY_NAME), 25)
                        .add(new CrateReward(PickaxeTemplates.TIER_2.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, PickaxeTemplates.TIER_2.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item), "1x " + PickaxeTemplates.TIER_2.DISPLAY_NAME), 20)
                        .add(new CrateReward(PickaxeTemplates.TIER_3.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, PickaxeTemplates.TIER_3.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item), "1x " + PickaxeTemplates.TIER_3.DISPLAY_NAME), 15)
                        .add(new CrateReward(PickaxeTemplates.TIER_4.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, PickaxeTemplates.TIER_4.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item), "1x " + PickaxeTemplates.TIER_4.DISPLAY_NAME), 12.5)
                        .add(new CrateReward(PickaxeTemplates.TIER_5.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, PickaxeTemplates.TIER_5.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item), "1x " + PickaxeTemplates.TIER_5.DISPLAY_NAME), 10)
                        .add(new CrateReward(PickaxeTemplates.TIER_6.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, PickaxeTemplates.TIER_6.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item), "1x " + PickaxeTemplates.TIER_6.DISPLAY_NAME), 7.5)
                        .add(new CrateReward(PickaxeTemplates.TIER_7.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, PickaxeTemplates.TIER_7.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item), "1x " + PickaxeTemplates.TIER_7.DISPLAY_NAME), 6)
                        .add(new CrateReward(PickaxeTemplates.TIER_8.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, PickaxeTemplates.TIER_8.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item), "1x " + PickaxeTemplates.TIER_8.DISPLAY_NAME), 2.5)
                        .add(new CrateReward(PickaxeTemplates.TIER_9.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, PickaxeTemplates.TIER_9.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item), "1x " + PickaxeTemplates.TIER_9.DISPLAY_NAME), 1)
                        .add(new CrateReward(PickaxeTemplates.TIER_10.buildPickaxe().delete().item, p -> PrisonUtils.Players.addToInventory(p, PickaxeTemplates.TIER_10.buildPickaxe().setBottomLore(List.of("", "&7Won from a &aPickaxe &7crate")).tryToUpdateLore().item), "1x " + PickaxeTemplates.TIER_10.DISPLAY_NAME), 0.5)
        );
