    ...
    public static void init() {
        ...
        COMMON = new Crate("common", "Common Crate", "common", new Location(Bukkit.getWorld("world"), -51, 80, -137),
                new WeightedElements<CrateReward>()
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_1", null), 1)), 20)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_1", null), 2)), 10)
                        .add(new CrateReward(CustomItems.getItem("mine_bomb_2", null)), 5)
        ...
        RARE = new Crate("rare", "Rare Crate", "rare", new Location(Bukkit.getWorld("world"), -42, 80, -137),
                new WeightedElements<CrateReward>()
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_1", null), 3)), 5)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_2", null), 1)), 15)
                        .add(new CrateReward(CustomItems.getItem("mine_bomb_3", null)), 10)
        ...
        EPIC = new Crate("epic", "Epic Crate", "epic", new Location(Bukkit.getWorld("world"), -33, 80, -137),
                new WeightedElements<CrateReward>()
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_1", null), 4)), 10)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_2", null), 2)), 5)
                        .add(new CrateReward(CustomItems.getItem("mine_bomb_3", null)), 8)
                        .add(new CrateReward(CustomItems.getItem("mine_bomb_4", null)), 2)
        ...
        LEGENDARY = new Crate("legendary", "Legendary Crate", "legendary", new Location(Bukkit.getWorld("world"), -24, 80, -137),
                new WeightedElements<CrateReward>()
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_2", null), 4)), 7.5)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_3", null), 2)), 7.5)
                        .add(new CrateReward(CustomItems.getItem("mine_bomb_4", null)), 5)
        ...
        STATIC = new Crate("static", "Static Crate", "static", new Location(Bukkit.getWorld("world"), -15, 80, -137),
                new WeightedElements<CrateReward>()
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_2", null), 5)), 5)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_3", null), 2)), 7)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_3", null), 3)), 5)
                        .add(new CrateReward(CustomItems.getItem("mine_bomb_4", null)), 2)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_4", null), 2)), 1)
        ...
        STATICP = new Crate("staticp", "Static+ Crate", "staticp", new Location(Bukkit.getWorld("world"), 3, 80, -137),
                new WeightedElements<CrateReward>() //todo: get rid of the worse items
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_1", null), 24)), 2)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_3", null), 4)), 5)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_3", null), 6)), 5)
                        .add(new CrateReward(CustomItems.getItem("mine_bomb_4", null)), 2)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_4", null), 2)), 2)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getItem("mine_bomb_4", null), 4)), 1)
