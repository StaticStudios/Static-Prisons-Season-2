    ...
    public static void init() {
        ...
        COMMON = new Crate("common", "Common Crate", "common", new Location(Bukkit.getWorld("world"), -51, 80, -137),
                new WeightedElements<CrateReward>()
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier1(), 1)), 20)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier1(), 2)), 10)
        ...
        RARE = new Crate("rare", "Rare Crate", "rare", new Location(Bukkit.getWorld("world"), -42, 80, -137),
                new WeightedElements<CrateReward>()
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier1(), 3)), 5)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier2(), 1)), 15)
        ...
        EPIC = new Crate("epic", "Epic Crate", "epic", new Location(Bukkit.getWorld("world"), -33, 80, -137),
                new WeightedElements<CrateReward>()
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier1(), 4)), 10)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier2(), 2)), 5)
        ...
        LEGENDARY = new Crate("legendary", "Legendary Crate", "legendary", new Location(Bukkit.getWorld("world"), -24, 80, -137),
                new WeightedElements<CrateReward>()
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier2(), 4)), 7.5)
        ...
        STATIC = new Crate("static", "Static Crate", "static", new Location(Bukkit.getWorld("world"), -15, 80, -137),
                new WeightedElements<CrateReward>()
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier2(), 5)), 5)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier3(), 2)), 7)
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier3(), 3)), 5)
                        .add(new CrateReward(CustomItems.getMineBombTier4()), 2)
        ...
        STATICP = new Crate("staticp", "Static+ Crate", "staticp", new Location(Bukkit.getWorld("world"), 3, 80, -137),
                new WeightedElements<CrateReward>() //todo: get rid of the worse items
                        ...
                        .add(new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier1(), 24)), 2)
