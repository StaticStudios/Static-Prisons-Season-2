...
public class StaticpCrate {
    ...
    public static CrateReward[] rewards = new CrateReward[] {
            new CrateReward(PrisonUtils.setItemCount(Vouchers.MONEY_POUCH_T1.item, 4), 2),
            new CrateReward(PrisonUtils.setItemCount(Vouchers.MONEY_POUCH_T2.item, 3), 2),
            new CrateReward(PrisonUtils.setItemCount(Vouchers.MONEY_POUCH_T2.item, 4), 2.5),
            new CrateReward(Vouchers.MONEY_POUCH_T3.item, 6),
            new CrateReward(PrisonUtils.setItemCount(Vouchers.MONEY_POUCH_T3.item, 2), 2),
            new CrateReward(PrisonUtils.setItemCount(Vouchers.TOKEN_POUCH_T1.item, 4), 3),
            new CrateReward(PrisonUtils.setItemCount(Vouchers.TOKEN_POUCH_T2.item, 3), 4.5),
            new CrateReward(PrisonUtils.setItemCount(Vouchers.TOKEN_POUCH_T2.item, 4), 3),
            new CrateReward(Vouchers.TOKEN_POUCH_T3.item, 7),
            new CrateReward(PrisonUtils.setItemCount(Vouchers.TOKEN_POUCH_T3.item, 2), 2),
            new CrateReward(Vouchers.MULTI_POUCH_T1.item, 1),
            new CrateReward(PrisonUtils.setItemCount(Vouchers.MULTI_POUCH_T1.item, 3), 3),
            new CrateReward(Vouchers.MULTI_POUCH_T2.item, 2),
            new CrateReward(PrisonUtils.setItemCount(Vouchers.MULTI_POUCH_T2.item, 2), 2),
            new CrateReward(Vouchers.MULTI_POUCH_T3.item, 3),
            new CrateReward(PrisonUtils.setItemCount(Vouchers.MULTI_POUCH_T3.item, 2), 3),
            new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier1(), 32), 2),
            new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier3(), 4), 5),
            new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier3(), 6), 5),
            new CrateReward(CustomItems.getMineBombTier4(), 2),
            new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier4(), 2), 2),
            new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier4(), 4), 1),
