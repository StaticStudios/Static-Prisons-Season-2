...
public class LegendaryCrate {
    ...
    public static CrateReward[] rewards = new CrateReward[] {
            ...
            new CrateReward(PrisonUtils.setItemCount(Vouchers.TOKEN_POUCH_T1.item, 2), 7),
            new CrateReward(PrisonUtils.setItemCount(Vouchers.TOKEN_POUCH_T1.item, 3), 7),
            new CrateReward(Vouchers.TOKEN_POUCH_T2.item, 5),
            new CrateReward(Vouchers.MULTI_POUCH_T1.item, 7),
            new CrateReward(PrisonUtils.setItemCount(Vouchers.MULTI_POUCH_T1.item, 2), 6),
            new CrateReward(Vouchers.MULTI_POUCH_T2.item, 7),
            new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier2(), 5), 7.5),
            new CrateReward(PrisonUtils.setItemCount(CustomItems.getMineBombTier3(), 2), 7.5),
